    ...
    return (
        <div className='flex items-center justify-center h-100 '>
            <div className="flex w-full mx-10 rounded bg-white">
                <input className="flex-grow border-none bg-transparent px-4 py-1 text-gray-400 outline-none focus:outline-none" type="search" name="search" placeholder="Search..." />
